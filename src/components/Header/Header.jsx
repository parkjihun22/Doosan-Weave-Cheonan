...
const menuArray = [
  ...
  },
  {
    ...
    subMenu: [
      ...
      { subTitle: "공급정보", subUrl: "/BusinessGuide/documents" },
    ],
  },
  {
    title: "분양안내",
    subMenu: [
      ...
      { subTitle: "인지세납부안내", subUrl: "/SalesInfo/announcement" },
  ...
  },
  {
    ...
    subMenu: [
      ...
      // { subTitle: "122", subUrl: "/FloorPlan/84B" },
      ...
      <>
        ...
        <div className={styles.mobileHeader}>
          <div onClick={() => setIsMobileMenu((v) => !v)}>
            {!isMobileMenu ? (
              <AiOutlineMenu className={styles.icon} size={25} color="#04013d" />
            ) : (
              <IoCloseSharp className={styles.icon} size={25} color="#04013d" />
            )}
          </div>
          {isMobileMenu && (
            <SlideMenu
          ...
          <a href="tel:1533-8848">
            <IoCall className={styles.icon} size={25} color="#04013d" />
          </a>
        </div>
        {isInterestPopupOpen && (
          <InterestPopup
